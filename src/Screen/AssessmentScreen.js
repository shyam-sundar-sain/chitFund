  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.homeContainer}>
        <Text style={styles.assessmentHeadingText}>Assessments Categories</Text>

        <View style={styles.blogBox}>
          <Text style={styles.assessmentsText}>Fun Personality</Text>
          <TouchableOpacity>
        ...
        <View style={styles.blogBox}>
          <Text style={styles.assessmentsText}>Swipe Based</Text>
          <TouchableOpacity>
            <Text style={styles.seeAllText}>View all</Text>
          </TouchableOpacity>
        </View>
