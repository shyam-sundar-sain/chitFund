...
const SubPlanDetailModals = ({isVisible, onClose, planData}) => {
  console.log('isVisible mtt', isVisible);
  console.log('planData poo', planData);
  const navigation = useNavigation();
  const [subscriberId, setScriberId] = useState(false);
  console.log('subscriberId hyy', subscriberId);
  ...
  const PlanEnquiryData = async () => {
    try {
      ...
      if (response) {
        ...
        console.log('newResponse mww', newResponse);
      ...
      <Modal
        ...
        <View style={styles.modalContainer}>
          ...
          <TouchableOpacity
            ...
            // onPress={() => navigation.navigate('KycVerificationAdhar')}
            onPress={() => {
...
export default SubPlanDetailModals;
